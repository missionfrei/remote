...
FD_JS = r'''
  ...
  var PROFILES={
   "lisamaria26":{ber:{buero:3,start:1,sprache:0.5,service:0},
     ...
     hard:["developer","software engineer","devops","data engineer","qa engineer"],exempt:/travel|reise|touristik|tourism|reservat|reservier|booking|buchung|hotel|flug|kreuzfahrt|assistenz|assistant|back\s?office|sachbearbeit/i,langs:["de","en"],reg:{world:3,eu:2,de:1}},
   "annette26":{ber:{service:3,buero:2,start:0.5},
     ...
     hard:["developer","software engineer","devops","buchhalt","steuerber","steuerfach","bilanzbuch","lohnbuchhalt","datev","accountant","accounting","bookkeep"],langs:["de","en"],reg:{world:3,eu:2,de:1}},
   ...
   "merlin26":{ber:{service:3,it:2,buero:1,start:0.5,sprache:1},
     plus:["kundenservice","kundensupport","kundenbetreuung","kundendienst","customer support","customer service","customer care","chat support","email support","e-mail support","technischer support","technischer kundenservice","technical support","helpdesk","help desk","it-support","it support","service desk","1st level","first level","second level","support agent","support specialist","ticket","betreuung","content moderat","moderator","qualitaetspruef","qualitätsprüf","datenerfassung","data entry","dateneingabe","annotation","ai training","rater","transkription","teilzeit","werkstudent","quereinsteiger","backoffice","back office","sachbearbeit","auftragsabwicklung"],
   ...
   "leia26":{ber:{marketing:3,buero:2,start:1,sprache:0.5,service:0},
