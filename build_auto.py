...
FD_JS = r'''
  ...
  var PROFILES={
   /* Lisa (26.09., Pauls Vorgabe): Backoffice, Sachbearbeitung, administrative Assistenz,
      E-Mail-Bearbeitung, Datenpflege, Reservierungen - und moeglichst WENIG Kundenkontakt.
      Telefonlastige Titel (Call Center, Telefonist, Outbound) fliegen deshalb hart raus. */
   ...
   "annette26":{ber:{service:3.5,gesundheit:2,buero:1.5,start:0.5},
     plus:["customer","support","kundenservice","kundensupport","kundenbetreuung","kundenbetreuer","kundenberater","kundenberatung","kundendienst","kundendialog","servicecenter","serviceberater","betreuung","service","technischer support","technischer kundenservice","customer care","inbound","erste anlaufstelle","anfragen","auftragsannahme","reklamation","ticket","chat support","email support","e-mail support","1st level","first level","assistant","assistenz","office","back office","administration","verwaltung","sachbearbeit","empfang"],
     minus:["vertrieb","sales","telesales","verkauf","telefonverkauf","akquise","kaltakquise","outbound","provision","neukunden","business development","account executive","mediaberater","closer","setter","direct sales","aussendienst","außendienst","developer","engineer","software","buchhaltung","accounting","steuer","datev","designer","devops","controlling","lohn","bilanz","wirtschaftsprüf"],
     hard:["developer","software engineer","devops","buchhalt","steuerber","steuerfach","bilanzbuch","lohnbuchhalt","datev","accountant","accounting","bookkeep","vertrieb","sales manager","sales representative","sales development","account executive","business development","sdr","telesales","akquise","closer","appointment setter","setter","mediaberater","verkäufer","außendienst","cold call"],langs:["de","en"],reg:{world:3,eu:2,de:1}},
   ...
   /* Profil A: Schwerpunkt Kundenservice und IT/Tech. Ausgeschlossen: Vertrieb, Kaltakquise,
      ...
      26.09.: plus-Block um die Titel erweitert, unter denen Support aktuell ausgeschrieben wird
      (technischer Kundensupport, Application Support, Fachinformatiker, Service Desk Agent, Supporter). */
   ...
   "leia26":{ber:{marketing:3.5,start:1,sprache:0.5,buero:0.5,service:0,gesundheit:1},
     plus:["marketing","online marketing","social media","social content","content","content creation","content creator","creator","ugc","contentproduktion","redaktion","texter","copywriter","copywriting","autor","schreiben","storytelling","blog","newsletter","grafik","grafikdesign","design","designer","gestalter","mediengestalter","art direction","illustration","visuelles marketing","visual","kreativ","creative","canva","figma","photoshop","adobe","capcut","video","videobearbeitung","videoschnitt","cutter","schnitt","editor","motion","reels","tiktok","instagram","youtube","shortform","bildbearbeitung","podcast","community management","community manager","influencer","kooperation","paid social","performance marketing","kampagne","brand","marke","e-commerce","shop","produktdaten","seo"],
     minus:["kundenservice","kundensupport","kundenbetreuung","kundendienst","customer service","customer support","customer care","customer success","call center","callcenter","telefonie","telefonist","inbound","outbound","helpdesk","help desk","it-support","it support","service desk","technischer support","support agent","beschwerde","sachbearbeit","buchhaltung","rechnungswesen","datenerfassung","verwaltung","developer","engineer","software","devops","systemadmin","netzwerk","handwerk","montage","lager","vertrieb","telesales","closer","setter","akquise","aussendienst","außendienst"],
     hard:["kundenservice","kundensupport","kundenbetreuung","customer service","customer support","customer care","customer success","callcenter","call center","call-center","helpdesk","help desk","it-support","it support","service desk","technischer support","support agent","support specialist","telefonist","developer","software engineer","devops","systemadmin","telesales","appointment setter","kaltakquise","außendienst","senior","architekt"],langs:["de","en"],reg:{world:3,eu:2,de:1}}
  };
