...
FD_JS = r'''
  ...
  var PROFILES={
   "lisamaria26":{ber:{buero:3,start:1,sprache:0.5,service:0},
     ...
     hard:["developer","software engineer","devops","data engineer","qa engineer"],exempt:/travel|reise|touristik|tourism|reservat|reservier|booking|buchung|hotel|flug|kreuzfahrt|assistenz|assistant|back\s?office|sachbearbeit/i,langs:["de","en"],reg:{world:3,eu:2,de:0}},
